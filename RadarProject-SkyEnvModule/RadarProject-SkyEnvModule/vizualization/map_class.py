...
class MapWindow(QMainWindow):
    def __init__(self, ):
        ...
        self.resize(float(screen_geometry.width()*0.6), float(screen_geometry.height()*0.6))
        self.move(screen_geometry.width()*0.1, screen_geometry.height()*0.1)
    ...
    def animate_plane_movement(self, plane_data, target_x, target_y, id):
           ...
           for i in range(1, steps + 1):
                ...
                self.map_view.add_to_trail(id, QPoint(x, y))
